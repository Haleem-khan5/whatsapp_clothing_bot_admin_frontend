...
export function DashboardLayout() {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-white via-indigo-50 to-pink-50">
        <AppSidebar />
        <div className="flex-1 flex flex-col">
          <header className="h-16 sticky top-0 z-10 px-6 flex items-center justify-between border-b border-indigo-100/70 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-md">
          ...
          <main className="flex-1 p-6 bg-gradient-to-br from-white/70 via-indigo-50/60 to-pink-50/60">
