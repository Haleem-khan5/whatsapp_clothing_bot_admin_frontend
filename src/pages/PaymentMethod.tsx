...
import { usePaymentMethod, useDeletePaymentMethod } from '@/hooks/useLookups';
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-pink-500 to-pink-400 text-white rounded-2xl p-6 shadow-md">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight">Payment Method Catalog</h1>
            <p className="text-sm text-white/80 mt-1">
              Manage and configure accepted payment methods.
            </p>
          </div>
          <Button
      ...
      <Card className="shadow-xl border-none bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-purple-700 text-xl font-semibold">Payment Methods</CardTitle>
          <CardDescription className="text-purple-400 font-medium">
            Below is the list of all available payment methods for transactions.
          </CardDescription>
        </CardHeader>
      ...
      <PaymentMethodDialog open={dialogOpen} onOpenChange={setDialogOpen} item={selected} />
    </div>
  );
}
